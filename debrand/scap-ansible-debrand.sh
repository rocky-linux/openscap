...
declare -a Debrand=("s/rhel8/rocky8/g" "s/redhat/rocky/g" "s/CentOS/Rocky/g" "s/RedHat/Rocky/g" "s/Red\ Hat/Rocky/g")
...
then
	...
	declare -a Files=(`find /home/jgordon/scripts/ansible/ -type f -not -path '*/\.*'`)
