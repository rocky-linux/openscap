# platform = Red Hat Enterprise Linux 7,Red Hat Enterprise Linux 8,Red Hat Virtualization 4,multi_platform_fedora,multi_platform_wrlinux,multi_platform_ol,multi_platform_rocky
# reboot = false
# complexity = low
# strategy = configure
# disruption = low
